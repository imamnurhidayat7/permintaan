        ...
        <div class="row mb-2">
            ...
            <div class="card mini-stats-wid px-4 py-4">
                <div class="card-body">
                    ...
                    <form action="{{url('tambah-keamanan-siber')}}" method="post" class="myForm" enctype="multipart/form-data">@csrf
                    <div class="row mt-4 py-4">
                        <div class="col-md-12 mb-2">
                            <label for="">Jenis Layanan*</label>
                            <select name="jenis" id="type" class="form-control" required>
                                <option value="">Pilih Jenis Layanan</option>
                                <option value="Edukasi dan Pelatihan Keamanan Siber (Education/Training)">Edukasi dan Pelatihan Keamanan Siber (Education/Training)</option>
                                <option value="Penanggulangan dan Pemulihan Insiden Siber (Incident Handling)">Penanggulangan dan Pemulihan Insiden Siber (Incident Handling)</option>
                            </select>
                        </div>
                        <div class="col-md-12 mb-2">
