            ...
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="{{url('/pelaksana/dashboard')}}" class="logo">
                            <span class="logo-sm">
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href="{{url('pelaksana/dashboard')}}"><i class="bx bx-home font-size-16 align-middle me-1"></i><span key="t-dashboard"> Dashboard</span></a>
            ...
            <div class="container-fluid">
                <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                    ...
                    <div class="collapse navbar-collapse" id="topnav-menu-content">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="{{url('pelaksana/dashboard')}}" id="topnav-dashboard" role="button"
                                    >
                                    <i class="bx bx-file me-2"></i><span key="t-dashboards">Dashboard</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{url('pelaksana/request')}}" id="topnav-dashboard" role="button"
                                    >
                                    <i class="bx bx-file me-2"></i><span key="t-dashboards">Semua Request</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{url('pelaksana/request-saya')}}" id="topnav-dashboard" role="button"
                                    >
