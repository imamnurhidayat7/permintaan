@extends('pelaksana.master_pelaksana')
                    ...
                    <div class="card-body">
                        <div class="media">
                            <div class="media-body">
                                ...
                                <a href="{{url('pelaksana/request')}}" class="btn btn-primary mt-2 waves-effect waves-light btn-sm">Details<i class="mdi mdi-arrow-right ms-1"></i></a>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="media">
                            <div class="media-body">
                                ...
                                <a href="{{url('pelaksana/request-saya')}}" class="btn btn-primary mt-2 waves-effect waves-light btn-sm">Details<i class="mdi mdi-arrow-right ms-1"></i></a>
                            </div>
