@extends('customerservice.master_customerservice')
                    ...
                    <div class="card-body">
                        <div class="media">
                            <div class="media-body">
                                ...
                                <a href="{{url('cs/request')}}" class="btn btn-primary mt-2 waves-effect waves-light btn-sm">Details<i class="mdi mdi-arrow-right ms-1"></i></a>
                            </div>
                    ...
                    <div class="card-body">
                        <div class="media">
                            <div class="media-body">
                                ...
                                <a href="{{url('cs/request-saya')}}" class="btn btn-primary mt-2 waves-effect waves-light btn-sm">Details<i class="mdi mdi-arrow-right ms-1"></i></a>
                            </div>
