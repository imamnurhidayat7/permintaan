...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="{{ URL::asset('/css/tagsinput.css?v2.4') }}" rel="stylesheet" type="text/css" />
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <!-- <a class="dropdown-item" href="{{url('admin/profile')}}"><i class="bx bx-user font-size-16 align-middle me-1"></i><span key="t-dashboard"> Profil User</span></a> -->
                ...
                <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
                    ...
                    <div class="collapse navbar-collapse" id="topnav-menu-content">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-dashboard" role="button">
                                    <i class="bx bx-file me-2"></i><span key="t-dashboards">Data Request</span> <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-dashboard">
                                    <a class="nav-link" href="{{url('request')}}" id="topnav-dashboard" role="button">
                                        <span key="t-dashboards">Semua Request Layanan</span>
                                    </a>      
                                    <a class="nav-link" href="{{url('tunggakan-saya')}}" id="topnav-dashboard" role="button">
                                        <span key="t-dashboards">Tunggakan Request</span>
                                    </a> 
